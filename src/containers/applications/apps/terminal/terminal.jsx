...
export const WnTerminal = () => {
  ...
  const cmdTool = async (cmd) => {
    ...
    if (type == "echo") {
      ...
      tmpStack.push(
        "A autenticação é feita pela tela de entrada do simulador."
      );
      ...
      tmpStack.push("");
      tmpStack.push("IPv4 Address. . . . . . . . . . . : 192.168.1.100");
      tmpStack.push("Subnet Mask . . . . . . . . . . . : 255.255.255.0");
      tmpStack.push("Default Gateway . . . . . . . . . : 192.168.1.1");
    } else {
      tmpStack.push(
  ...
  return (
    <AppWindow
      ...
      windowScreenClassName="flex"
      restWindowClassName="h-full flex-grow text-gray-100"
    >
      <div
