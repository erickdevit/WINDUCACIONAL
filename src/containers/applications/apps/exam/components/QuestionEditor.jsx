...
export const QuestionEditor = ({ exam, onBack }) => {
  ...
  const addRule = () => {
    setNewNewQ({
      ...newQ,
      validationRules: [
        ...newQ.validationRules,
        { type: "FILE_EXISTS", path: "", content: "", name: "" },
      ],
    });
  };
        ...
        <div className="flex justify-between items-start mb-2">
          <span
            className={`question-type ${
              q.type === "mcq" ? "mcq" : "practical"
            }`}
          >
            {q.type === "mcq" ? "Múltipla escolha" : "Prática"}
          </span>
          <span className="question-meta">
            {q.points} pts{q.timeLimit > 0 ? ` · ${q.timeLimit} min` : ""}
          </span>
        </div>
            ...
            {(q.options || []).map((opt, idx) => (
              <div
                ...
                className={`text-xs p-2 rounded border ${
                  q.correctAnswer === String.fromCharCode(97 + idx)
              ...
              <form onSubmit={handleSave} className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      value={newQ.type}
                      onChange={(e) =>
                        setNewNewQ({ ...newQ, type: e.target.value })
                      }
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={newQ.points}
                      onChange={(e) =>
                        setNewNewQ({ ...newQ, points: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={newQ.text}
                    onChange={(e) =>
                      setNewNewQ({ ...newQ, text: e.target.value })
                    }
                  />
                </div>
                ...
                {newQ.type === "mcq" ? (
                    ...
                    {newQ.options.map((opt, i) => (
                      <div key={i} className="flex gap-3 items-center">
                        ...
                        <input
                          ...
                          name="correct"
                          checked={
                            newQ.correctAnswer === String.fromCharCode(97 + i)
                          }
                          onChange={() =>
                            setNewNewQ({
                              ...newQ,
                  ...
                  <div className="space-y-4">
                    ...
                    {newQ.validationRules.map((rule, i) => (
                      <div
                        key={i}
                        className="p-4 bg-gray-50 rounded-lg border flex gap-3 flex-wrap"
                      >
                        <select
                        ...
                        {rule.type === "ACTION_PERFORMED" ? (
                          ...
                          >
                            ...
                            <option value="EXPLORER">
                              Abrir Explorador de Arquivos (Win+E)
                            </option>
                            <option value="NOTEPAD">
                              Abrir Bloco de Notas
                            </option>
                            <option value="TERMINAL">
                              Abrir Terminal (Win+R)
                            </option>
                        ...
                        <button
                          ...
                          onClick={() => {
                            const next = newQ.validationRules.filter(
                              (_, idx) => idx !== i
                            );
                            setNewNewQ({ ...newQ, validationRules: next });
                          }}
