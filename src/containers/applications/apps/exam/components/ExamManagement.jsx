    ...
    <div className="exam-management animate-fade-in">
      ...
      <div className="exam-table-panel win11Scroll">
              ...
              <div className="card-info-row">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="card-value">
                    {exam.timeLimit > 0 ? `${exam.timeLimit} min` : "---"}
                  </span>
                </div>
        ...
        <table className="w-full text-left exam-desktop-table">
          <thead>
            <tr>
              <th className="p-5 font-bold text-xs text-gray-400 uppercase tracking-widest">
                Status
              </th>
              <th className="p-5 font-bold text-xs text-gray-400 uppercase tracking-widest">
                Título
              </th>
              <th className="p-5 font-bold text-xs text-gray-400 uppercase tracking-widest text-center">
                Tempo
              </th>
              <th className="p-5 font-bold text-xs text-gray-400 uppercase tracking-widest text-center">
                Criada em
              </th>
              <th className="p-5 font-bold text-xs text-gray-400 uppercase tracking-widest text-right">
                Ações
              </th>
            </tr>
          </thead>
