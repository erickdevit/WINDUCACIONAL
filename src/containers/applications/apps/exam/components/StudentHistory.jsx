        ...
        <div className="exam-card-list exam-mobile-only p-4">
          {submissions.map((sub) => (
            <article
              ...
              onClick={() =>
                sub.status === "completed" && setSelectedSubmission(sub)
              }
            >
              <div className="flex justify-between items-start gap-2">
                <div>
                  <h4 className="text-blue-700 m-0 leading-tight">
                    {sub.examTitle}
                  </h4>
              ...
              <div className="card-info-row mt-2">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="card-value text-xl text-blue-600 font-black">
                    {sub.totalScore !== undefined ? sub.totalScore : "-"}
                  </span>
                </div>
                <div className="flex flex-col gap-1 text-right">
                  <span className="card-label">Data</span>
                  <span className="card-value font-normal text-xs">
                    {sub.completedAt
