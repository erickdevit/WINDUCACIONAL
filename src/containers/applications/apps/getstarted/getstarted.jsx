    ...
    >
      <div className="inner_fill_setup">
        ...
        {pageNo === 2 ? (
          <>
            <div className="left">
              <img id="left_img" src="img/oobe/window11_oobe_keyb_layout.png" />
            </div>
            <div className="right">
              <div className="header">
                {t("oobe.keyboard")}
                <div className="header_sml">{t("oobe.anotherkeyboard")}</div>
              </div>
              <div className="list_oobe mt-4 win11Scroll">
                <LangSwitch />
              </div>
          ...
          <>
            ...
            <div className="right">
              ...
              <div className="header_sml">
                ...
                connecting to it from other devices.Your Pc will restart after
                you name it.
              </div>
          ...
          <>
            ...
            <div className="right">
              <div className="header">
                ...
                <div className="header_sml">
                  You'll need an internet connection to continue the setting up
                  your device.Once connected, you'll get the latest features and
                  security updates.
                </div>
