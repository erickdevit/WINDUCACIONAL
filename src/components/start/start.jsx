...
import { formatRecentUsage, getUserDisplayName } from "../../lib/ui";
import {
  canDisplayAppForUser,
  filterAppsForUser,
} from "../../lib/appVisibility";
...
export const StartMenu = () => {
  ...
  const start = useSelector((state) => {
    ...
    arr.pnApps = [...state.startmenu.pnApps];

    const user = state.setting?.person;
    arr.pnApps = filterAppsForUser(arr.pnApps, user);
    arr.rcApps = filterAppsForUser(state.startmenu.rcApps, user);

    var ln = (6 - (arr.pnApps.length % 6)) % 6;
    ...
    var allApps = [],
      tmpApps = Object.keys(state.apps)
        ...
        .filter((app) => canDisplayAppForUser(app, user));
        ...
        <>
            ...
            <div className="menuUp">
              <div className="pinnedApps">
                <div className="stAcbar">
                  <div className="gpname">Fixados</div>
                  <div
                    className="gpbtn prtclk"
                    onClick={clickDispatch}
                    data-action="STARTALL"
                  >
                    <div>Todos os aplicativos</div>
              ...
              <div className="recApps win11Scroll">
                <div className="stAcbar">
                  <div className="gpname">Recomendados</div>
                      ...
                      >
                        ...
                        <div className="acInfo">
                          ...
                          <div className="timeUsed">
                            {formatRecentUsage(app.lastUsed)}
                          </div>
                        </div>
                      </div>
                    ) : null;
          ...
          <div className="allCont" data-allapps={start.showAll}>
            <div className="appCont">
              <div className="stAcbar">
                <div className="gpname">Todos os aplicativos</div>
                <div
                  className="gpbtn prtclk"
                  onClick={clickDispatch}
                  data-action="STARTALL"
            ...
            <div className="relative powerMenu">
              <div className="powerCont" data-vis={start.pwctrl}>
                ...
                <div
                  className="flex prtclk items-center gap-2"
                  onClick={() =>
                    window.dispatchEvent(new Event("simulador:logout"))
                  }
                >
                  <svg
                    width="18"
          ...
          <div className="shResult w-full flex justify-between">
                ...
                <div className="textResult h-16">
                  <div className="smatch flex my-2 p-3 rounded">
                    ...
                    <div className="matchInfo flex-col px-2">
                      ...
                      <div className="text-xss">Aplicativo</div>
                    </div>
                  </div>
                  <div
            ...
            {query.length ? (
              <div className="w-2/3 rightSide rounded">
                ...
                <div className="text-xss mt-2">Aplicativo</div>
                ...
                >
                  ...
                  <div className="text-xss ml-3">Abrir</div>
                </div>
              </div>
            ) : null}
          </div>
