...
- Apostilas em PDF devem ser servidas pelo backend a partir do catálogo escaneado no diretório interno do app. O cliente recebe IDs seguros, nunca caminhos de arquivo; alunos só podem abrir módulos liberados em `booklet_module_access`, enquanto professores podem ver e configurar todos os módulos.
