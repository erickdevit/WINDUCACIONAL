...
- Simulador Montagem de PC com catálogo ilustrado, bancada alternável entre 2D e 3D, validação técnica autoritativa e galeria visual persistente por usuário.
